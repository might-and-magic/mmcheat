-- zzlib - zlib/deflate decompression in pure Lua, by Francois Galea
-- https://codeberg.org/zerkman/zzlib - WTFPL license (see below)
-- Vendored for MMCheat as a single file (zzlib.lua + inflate-bit32.lua
-- merged, using LuaJIT's `bit` library). Used to decompress map files
-- read from the game's LOD archives. Do not edit; see upstream for updates.
...
local bit = rawget(_G, "bit32") or rawget(_G, "bit") or require("bit")
